...
runTest("Encodings should be codewords", (i) => G.isCodeword(G.encode(i)));
runTest("Encodings shouldn't be corrected", (i) => G.encode(i) === G.correct(G.encode(i)));
runTest("Encodings correct and decode properly", (i) => i === G.decode(G.correct(G.encode(i))));
